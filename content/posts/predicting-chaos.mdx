...
Not only that, but it's often trying to understand someone else's 'pure thought stuff' - to a deadline.
...
We've built a tool to help developers understand their code, and give them an unbiased view on how they actually work on it.
